...
public class stepDefination {
  ...
  public void check_if_browser_is_started() throws Throwable {
   ...
   @Then("^Home page is populated$")
    ...
    public void cards_displayed_are(String card) throws Throwable {
    ...
    @Given("^User is on the School website$")
    public void user_is_on_the_School_website() throws Throwable {
        System.out.println("Log into the School website...");
    }

    @When("^User click on get data button$")
    public void user_click_on_get_data_button() throws Throwable {

    	System.out.println("Please click on the get student data...");
    }
    @Then("^System will display name (.+)$")
    public void system_will_display_name(String name) throws Throwable {
        System.out.println("Student Name: "+name);
    }
    
    @And("^Class of the Student (.+)$")
    public void class_of_the_student(String cls) throws Throwable {
